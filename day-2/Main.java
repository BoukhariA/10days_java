...
//        System.out.println(p);
        // List<Product> prods = service.getProductWithText("black drawer");
        //     for(Product product : prods){
        //          System.out.println(product);
        //        }
        System.out.println("==============================================");
        System.out.println("Search a Particular by place");
        List<Product> prods = service.getPlace("Black Drawer");
        ...
        System.out.println("==============================================");
        System.out.println("Search products that are out of Warranty ");

        List<Product> Prods = service.getWarranty(2023);
        for(Product product : Prods){
              System.out.println(product);
        }
        ...
        final List<Product> filteredProducts = Prods.stream()

        .filter(product -> product.getWarranty() < 2021)
